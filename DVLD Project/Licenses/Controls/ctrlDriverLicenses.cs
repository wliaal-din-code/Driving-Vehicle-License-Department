    ...
    public partial class ctrlDriverLicenses : UserControl
    {
        ...
        public void LoadInfo(int DriverID)
        {
            ...
            if (_Driver == null)
            {
                ...
                MessageBox.Show("No driver  id = " + DriverID, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        public void LoadInfoByPersonID(int PersonID)
        {
            ...
            if (_Driver == null)
            {
                MessageBox.Show("No driver linek wite Person  id = " + PersonID, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
